...
/**
 * 正常系
 * Around(before) -> Before -> Around(after) -> After -> AfterReturning の順
 * 異常系
 * Around(before) -> Before -> Around(after) -> After -> AfterThrowing の順
 */
@Aspect
@Component
@Slf4j
public class LoggingAspect {
    ...
    // 戻り値がAccount
    @Before("execution(Account com.example.service.*.*(..))")
