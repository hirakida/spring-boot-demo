...
public class ApiController {
    ...
    @GetMapping("/")
    public Map<String, Response> index() {
        return Map.of("@ConfigurationProperties",
                      new Response(properties.getString().getValue1(),
                                   properties.getString().getValue2(),
                                   properties.getNumber().getValue1(),
                                   properties.getNumber().getValue2()),
                      "@Value",
                      new Response(str1, str2, number1, number2),
                      "Environment",
                      new Response(environment.getProperty("app.string.value1"),
                                   environment.getProperty("app.string.value2", String.class,
                                                           "Environment default"),
